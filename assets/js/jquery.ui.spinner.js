...
$.widget( "ui.spinner", {
	...
	_buttonHtml: function() {
		...
		case 'horizontal':
			return "" +
				"<a href='#' class='ui-spinner-button ui-spinner-up ui-corner-right'>" +
					"<span class='ui-icon " + this.options.icons.right + "'>&#9658;</span>" +
				"</a>" +
				"<a href='#' class='ui-spinner-button ui-spinner-down ui-corner-left'>" +
	...
	_spin: function( step, event ) {
		//==== Note ====//
		// Change here for add '-' as by default value of unanswered questions
		//alert(this.value())
		var value = this.value() == null ? -1 : this.value() || 0;
		if ( !this.counter ) {
			this.counter = 1;
		}
